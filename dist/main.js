...
class InfiniteLibraryApp {
    constructor(root) {
        ...
        this.detailContainerEl = null;
        this.searchInputEl = null;
        this.factionSelectEl = null;
        this.canonToggleEl = null;
        this.root = root;
        this.state = {
            documents: primeDocuments,
            agents: primeAgents,
            activeDocumentId: (_b = (_a = primeDocuments[0]) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : null,
            searchTerm: "",
            factionFilter: "all",
            showCanonOnly: false,
        };
        this.settingsStore = new LocalStorageStore("infinite-library.settings", {
    ...
    renderSettingsForm() {
        ...
        const keyField = this.createLabeledInput("API Key", "password", this.settings.apiKey, (value) => {
    ...
    createLabeledInput(labelText, type, value, onChange, helperText) {
    ...
    get filteredDocuments() {
        ...
        return this.state.documents
            ...
            const haystack = [doc.title, doc.text, (_a = agent === null || agent === void 0 ? void 0 : agent.name) !== null && _a !== void 0 ? _a : ""].join(" ").toLowerCase();
    ...
    refreshArchiveList() {
        ...
        documents.forEach((doc) => {
            ...
            meta.textContent = `${(_a = author === null || author === void 0 ? void 0 : author.name) !== null && _a !== void 0 ? _a : "Unknown author"} • ${doc.factionTag} • ${formatRelativeTime(doc.timestamp)}`;
            const badge = document.createElement("span");
            badge.className = "badge";
            const credibility = (_c = (_b = this.state.agents.find((agent) => agent.id === doc.authorId)) === null || _b === void 0 ? void 0 : _b.credibility) !== null && _c !== void 0 ? _c : 50;
            ...
            (_d = this.archiveListEl) === null || _d === void 0 ? void 0 : _d.appendChild(card);
        });
        if (!documents.some((doc) => doc.id === this.state.activeDocumentId)) {
            this.state.activeDocumentId = (_b = (_a = documents[0]) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : null;
            this.refreshDocumentView();
        }
    }
    refreshDocumentView() {
        ...
        const references = active.references
            .map((refId) => { var _a, _b; return (_b = (_a = this.state.documents.find((doc) => doc.id === refId)) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : "Unknown fragment"; })
            .filter(Boolean)
            .join(", ");
        meta.textContent = [
